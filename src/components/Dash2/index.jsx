            ...
            <div className="header-default">
              ...
              <div className="header-float-left">
                ...
                <div className="profile">
                  ...
                  <div className="photo">
                    <img className="image-profile" src="/img/image-profile@2x.svg" />
                  </div>
                </div>
              </div>
            </div>
            <div className="total-container">
              <TotalSales totalSales="Total Sales" x512K={totalsales} />
              <TotalSales
                totalSales="Total Cost"
                x512K={totalcost}
                className={totalSales2Props.className}
              />
              <div className="total-cost border-1px-limed-spruce">
                <Icons />
                <div className="label">
                  <div className="total-cost-1 mulish-bold-white-16px">Capital Returned</div>
                  <div className="price-1 mulish-bold-white-23px">{Math.round((totalsales/totalcost)*100)}</div>
                </div>
              </div>
            </div>
